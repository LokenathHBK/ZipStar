...
datePicker.setMaxDate(minDate);
    ...
    public static Calendar defaultCalendar() {
        ...
        currentDate.set(Calendar.DAY_OF_MONTH, Calendar.DAY_OF_MONTH+7); // Clearer than DATE
        return currentDate;
    }
    // Constructor end
    ...
    public void onTimeChanged(TimePicker view, int hourOfDay, int minute) {
        // Update the internal Calendar instance
           ...
           mCalendar.set(mCalendar.get(Calendar.YEAR), mCalendar.get(Calendar.MONTH), mCalendar.get(Calendar.DAY_OF_MONTH), hourOfDay, minute, Calendar.AM_PM);
