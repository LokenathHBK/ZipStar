...
int already_added;
    ...
    public AddStoreDataType(String store_id32, String store_namewow, String store_address1, String store_statewest, String pin, int getdistance, int already_added) {
